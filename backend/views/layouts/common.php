...
<div class="wrapper">
    ...
    <?php NavBar::begin([
        ...
        <?php echo Nav::widget([
            ...
            'items' => [
                [
                    // timeline events
                    'label' => FAR::icon('bell').' <span class="badge badge-success navbar-badge">'.  '</span>',
                ...
                '<li class="nav-item dropdown user-menu">
                    ...
                    <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        ...
                        <li class="user-header bg-primary">
                            ...
                            <p>
                                Profile
                                <small>'.Yii::t('backend', 'Member since {0,  , short}', Yii::$app->user->identity->created_at).'</small>
                            </p>
                        </li>
                        <!-- Menu Footer-->
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4 <?php echo $keyStorage->get('adminlte.sidebar-no-expand') ? 'sidebar-no-expand' : null ?>">
        <!-- brand logo -->
        <a href="http://ebirja.uz/" target="_blank" class="brand-link text-center <?php echo $keyStorage->get('adminlte.brand-text-small') ? 'text-sm' : null ?>">
            <!-- <img src="dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
                style="opacity: .8"> -->
            <span class="brand-text font-weight-bold"><?=t("E birja")?></span>
        </a>
        <!-- /brand logo -->
...
//                            'badge' => TimelineEvent::find()->today()->count(),
                        ...
                        [
                            ...
                            'items' => [
                                [
                                    'label' => Yii::t('backend', 'Moderator tekshiruvida'),
                                    'url' => ['/product/moderator?state=100'],
                                    'icon' => FAS::icon('database', ['class' => ['nav-icon']]),
                                    'active' => (Yii::$app->controller->id == 'storage'),
                                ],
                                [
                                    'label' => Yii::t('backend', 'Moderator rad etganlar'),
                                    'url' => ['/product/moderator-rejected?state=110'],
                                    'icon' => FAS::icon('database', ['class' => ['nav-icon']]),
                                    'active' => (Yii::$app->controller->id == 'storage'),
                                ],
                                [
                                    'label' => Yii::t('backend', "Mablag' yetarli emas"),
                                    'url' => ['/product/no-money?state=200'],
                                    'icon' => FAS::icon('database', ['class' => ['nav-icon']]),
                                    'active' => (Yii::$app->controller->id == 'storage'),
                                ],
                                [
                                    'label' => Yii::t('backend', 'Sotuvda'),
                                    'url' => ['/product/index'],
                                    'icon' => FAS::icon('database', ['class' => ['nav-icon']]),
                                    'active' => (Yii::$app->controller->id == 'storage'),
                                ],
                        ...
                        [
                            'label' => Yii::t('backend', 'Auction'),
                            'url' => '#',
                            'icon' => FAS::icon('folder-open', ['class' => ['nav-icon']]),
                            'options' => ['class' => 'nav-item has-treeview'],
                            'active' => (Yii::$app->controller->module->id == 'auction'),
                            'items' => [
                                [
                                    'label' => Yii::t('backend', 'Moderator tekshiruvida'),
                                    'url' => ['/auction/moderator?status=1'],
                                    'icon' => FAS::icon('database', ['class' => ['nav-icon']]),
                                    'active' => (Yii::$app->controller->id == 'storage'),
                                ],
                                [
                                    'label' => Yii::t('backend', 'Moderator rad etganlar'),
                                    'url' => ['/auction/moderator-rejected?status=4'],
                                    'icon' => FAS::icon('database', ['class' => ['nav-icon']]),
                                    'active' => (Yii::$app->controller->id == 'storage'),
                                ],

                                [
                                    'label' => Yii::t('backend', 'Moderator tasdiqlaganlar'),
                                    'url' => ['/auction/index'],
                                    'icon' => FAS::icon('database', ['class' => ['nav-icon']]),
                                    'active' => (Yii::$app->controller->id == 'storage'),
                                ],
                        ...
                        [
                            ...
                            'items' => [
                                [
                                    'label' => Yii::t('backend', 'Moderator tekshiruvida'),
                                    'url' => ['/tender/moderator?status=1'],
                                    'icon' => FAS::icon('database', ['class' => ['nav-icon']]),
                                    'active' => (Yii::$app->controller->id == 'storage'),
                                ],
                                [
                                    'label' => Yii::t('backend', 'Moderator rad etganlar'),
                                    'url' => ['/tender/moderator-rejected?status=4'],
                                    'icon' => FAS::icon('database', ['class' => ['nav-icon']]),
                                    'active' => (Yii::$app->controller->id == 'storage'),
                                ],
                        ...
                        [
                            'label' => Yii::t('backend', 'Classifier'),
                            'url' => '#',
                            'icon' => FAS::icon('folder-open', ['class' => ['nav-icon']]),
                            'options' => ['class' => 'nav-item has-treeview'],
                            'active' => (Yii::$app->controller->module->id == 'auction'),
                            'items' => [
                                [
                                    'label' => Yii::t('backend', 'Classifier category'),
                                    'url' => ['/classifier-category/index'],
                                    'icon' => FAS::icon('database', ['class' => ['nav-icon']]),
                                    'active' => (Yii::$app->controller->id == 'storage'),
                                ],
                                [
                                    'label' => Yii::t('backend', 'Classifier'),
                                    'url' => ['/classifier/index'],
                                    'icon' => FAS::icon('database', ['class' => ['nav-icon']]),
                                    'active' => (Yii::$app->controller->id == 'storage'),
                                ],
                        ...
                        [
                            'label' => Yii::t('backend', 'Company transaction'),
                            'url' => ['/company-transaction/index'],
                        ...
                        [
                            'label' => Yii::t('backend', 'Insofsiz ijrochilar'),
                            'url' => ['/black-list/index'],
                            'icon' => FAS::icon('sync', ['class' => ['nav-icon']]),
                        ],
                        [
                            'label' => Yii::t('backend', 'Unit'),
                            'url' => ['/unit/index'],
                            'icon' => FAS::icon('sync', ['class' => ['nav-icon']]),
                        ],
//                        [
