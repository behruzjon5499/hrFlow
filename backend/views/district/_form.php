        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <?php echo $form->field($model, 'region_id')->dropDownList(ArrayHelper::map(\common\models\Region::find()->all(), 'id', 'title_uz'), ['prompt' => Yii::t('backend', 'Please select an item...')]) ?>

                        <?php echo $form->field($model, 'extra_ids')->widget(Select2::class, [
                            'data' => ArrayHelper::map(\common\models\parser\ParserDistrict::find()->all(), 'id', 'title'),
                            'options' => [
                        ...
                        <?php echo $form->field($model, 'extra_auto_district_ids')->widget(Select2::class, [
                                'data' => ArrayHelper::map(\common\models\parser\ParserAutoDistrict::find()->all(), 'id', 'name'),
                                'options' => [
                                        'placeholder' => 'Tuman Auto uchun tanlang...',
                                        'multiple' => true,
                                ],
                                'pluginOptions' => [
                                        'allowClear' => true,
