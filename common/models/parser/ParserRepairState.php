...
/**
 * This is the model class for table "home_repairstatus".
 *
 * @property int $id
 ...
 */
class ParserRepairState extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasMany(HomeHome::class, ['repair_status_id' => 'id']);
    }
