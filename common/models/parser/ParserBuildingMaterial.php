...
/**
 * This is the model class for table "home_buildingtype".
 *
 * @property int $id
 ...
 */
class ParserBuildingMaterial extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasMany(HomeHome::class, ['building_type_id' => 'id']);
    }
