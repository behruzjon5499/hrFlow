...
namespace common\generators\mvc\model;
use Yii;
...
class Generator extends \yii\gii\Generator
{
    ...
    public $scopeTraitsNs;
    public $relationTraitsNs;
    public $getterTraitsNs;
    public $setterTraitsNs;
    public $serviceNs;
    public $repositoryNs;
    public $dtoNs;
    ...
    public function rules()
    {
        return array_merge(parent::rules(), [
            ...
            [['db'], 'validateDb'],
            [['ns', 'queryNs','scopeTraitsNs','relationTraitsNs','getterTraitsNs',
                'setterTraitsNs','serviceNs','dtoNs','repositoryNs'
            ], 'validateNamespace'],
    ...
    public function attributeLabels()
    {
        return array_merge(parent::attributeLabels(), [
            ...
            'scopeTraitsNs'=>'Scope Trait Namespace',
            'relationTraitsNs'=>'Relation Trait Namespace',
            'getterTraitsNs'=>'Getter Trait Namespace',
            'setterTraitsNs'=>'Setter Trait Namespace',
            'serviceNs'=>'Service Namespace',
            'repositoryNs'=>'Repository Namespace',
            'dtoNs'=>'DTO Namespace'
        ]);
    }
    ...
    public function generate()
    {
        ...
        foreach ($this->getTableNames() as $tableName) {
            ...
            $params = [
                ...
                'traitScopeClassName'=>$modelClassName.'ScopeTrait',
                'traitRelationClassName'=>$modelClassName.'RelationTrait',
                'traitGetterClassName'=>$modelClassName.'GetterTrait',
                'traitSetterClassName'=>$modelClassName.'SetterTrait',
                'serviceClassName'=>$modelClassName.'Service',
                'createDTOClassName'=>$modelClassName.'CreateDTO',
                'updateDTOClassName'=>$modelClassName.'UpdateDTO',
            ...
            if($this->template =='mvc') {
                ...
                if ($modelClassName) {
                    ...
                    $traitScopeClassName =$params['traitScopeClassName'];
                    $params['className'] = $traitScopeClassName;
                    $params['modelClassName'] = $modelClassName;
                    $files[] = new CodeFile(
                        Yii::getAlias('@' . str_replace('\\', '/', $this->scopeTraitsNs)) . '/' . $traitScopeClassName . '.php',
                        $this->render('trait_scope.php', $params)
                    );



                    $traitRelationClassName =$params['traitRelationClassName'];
                    $params['className'] = $traitRelationClassName;
                    $params['modelClassName'] = $modelClassName;
                    $files[] = new CodeFile(
                        Yii::getAlias('@' . str_replace('\\', '/', $this->relationTraitsNs)) . '/' . $traitRelationClassName . '.php',
                        $this->render('trait_relation.php', $params)
                    );


                    $traitGetterClassName =$params['traitGetterClassName'];
                    $params['className'] = $traitGetterClassName;
                    $params['modelClassName'] = $modelClassName;
                    $files[] = new CodeFile(
                        Yii::getAlias('@' . str_replace('\\', '/', $this->getterTraitsNs)) . '/' . $traitGetterClassName . '.php',
                        $this->render('trait_getter.php', $params)
                    );


                    $traitSetterClassName =$params['traitSetterClassName'];
                    $params['className'] = $traitSetterClassName;
                    $params['modelClassName'] = $modelClassName;
                    $files[] = new CodeFile(
                        Yii::getAlias('@' . str_replace('\\', '/', $this->setterTraitsNs)) . '/' . $traitSetterClassName . '.php',
                        $this->render('trait_setter.php', $params)
                    );
                    $repositoryClassName =$params['repositoryClassName'];
                    $params['className'] = $repositoryClassName;
                    $params['modelClassName'] = $modelClassName;
                    $files[] = new CodeFile(
                        Yii::getAlias('@' . str_replace('\\', '/', $this->repositoryNs)) . '/' . $repositoryClassName . '.php',
                        $this->render('repository.php', $params)
                    );

                    $serviceNsClassName =$params['serviceClassName'];
                    $params['className'] = $serviceNsClassName;
                    $params['modelClassName'] = $modelClassName;
                    $files[] = new CodeFile(
                        Yii::getAlias('@' . str_replace('\\', '/', $this->serviceNs)) . '/' . $serviceNsClassName . '.php',
                        $this->render('service.php', $params)
                    );


                    $createDTONsClassName =$params['createDTOClassName'];
                    $params['className'] = $createDTONsClassName;
                    $params['modelClassName'] = $modelClassName;
                    $files[] = new CodeFile(
                        Yii::getAlias('@' . str_replace('\\', '/', $this->dtoNs)) . '/'.lcfirst($modelClassName).'/' . $createDTONsClassName . '.php',
                        $this->render('dto/createDTO.php', $params)
                    );

                    $updateDTONsClassName =$params['updateDTOClassName'];
                    $params['className'] = $updateDTONsClassName;
                    $params['modelClassName'] = $modelClassName;
                    $files[] = new CodeFile(
                        Yii::getAlias('@' . str_replace('\\', '/', $this->dtoNs)) . '/'.lcfirst($modelClassName).'/' . $updateDTONsClassName . '.php',
                        $this->render('dto/updateDTO.php', $params)
                    );
                }
            }
        }
